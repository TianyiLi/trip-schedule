...
const Layout: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: '/planning', icon: Calendar, label: t('navigation.planning') },
    { path: '/navigation', icon: MapPin, label: t('navigation.navigate') },
    { path: '/archived', icon: Archive, label: t('navigation.archived') },
